...
export const CardEstadistica = () => {
  ...
  const fetchExportacionesData = async () => {
    try {
      ...
      // Procesar Total FOB Dólar por Año
      ...
      // Procesar Total Peso Neto por Año
  ...
  // Llama a la función de obtención de datos al montar el componente y cuando cambia selectedYear
  useEffect(() => {
